...
paper_button=Button(iconsbarr,bg="#15b4ea",padx=0,pady=0,command=description, relief="flat",image=paper,activebackground="#15b4ea",compound="top" ,font=("Louis George Cafe",20),text="DESCRIPT°",fg="white",activeforeground="white")
